...
for(var i = 0; i<coordinates.length; i++){
  var coord = coordinates[i].split(/,/);
   ...
   ball[i] = new Balls(positionX,positionY,size,magyar,i);
}
...
function Menu(y,t){  
 ...
 this.show = function(){ 
    ...
    if(this.txt == 4){
     ...
     textFont("Impact",25);
     text("Költözés",this.x+10,this.y+30);
      fill(76, 144, 255);
    }
    if(this.txt == 5){
     ...
     textFont("Impact",25);
   text("Születési hely",this.x+10,this.y+30);
      fill(76, 144, 255);
    }
